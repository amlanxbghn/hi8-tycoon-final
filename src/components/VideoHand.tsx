...
const VideoHand = () => {
  return (
    <div className="px-4">
      <div className="relative w-full min-h-[600px] bg-gradient-to-br from-orange-50/50 to-orange-200 flex justify-center items-end overflow-hidden pt-32 rounded-3xl">
        {/* Background Text */}
